...
-   Read the following articles and take notes in Obsidian. Try using Markdown to format your text.
    ...
    -   [*How to (Seriously) Read a Scientific Paper*](https://www.science.org/content/article/how-seriously-read-scientific-paper){target="_blank"} [-@painHowSeriouslyRead2016]
