...
::: {.learning-activity time="30"}
-   Watch [*Mind Mapping in Obsidian Canvas*](https://www.youtube.com/watch?v=eHI-Szjpafk){target="_blank"} (2023). As you watch, follow the directions and to create a concept map in Obsidian. At the end of this unit, you will create a concept map for Units 1-3. Practice using notes, media, cards, and grouping features in a mind map.
