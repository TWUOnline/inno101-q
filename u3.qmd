...
<!-- @cmaadland this unit still needs to be fleshed out.  I'd suggest adding more of your commentary to topics 3-5 (written, video, or audio)  -->
...
::: {#fig-wikilink}
![](assets/u3/wikilink.png){.lightbox fig-alt="Screenshot, how to create a Wikilink in Obsidian" fig-align="left" width="400"}
...
::: {#fig-wikilink2}
![](assets/u3/wikilink2.png){fig-alt="Screenshot showing Wikilink "article1.md" created in Obsidian" .lightbox fig-align="left" width="300"}
...
Feel free to discuss your experience on the [Learning Community](https://twu.discourse.group/auth/microsoft_office365){target="_blank"} in Learning Community. You can also post any questions you have about this process and get technical support from your instructors and facilitators.
:::
...
Remember to reach out for support on the [Learning Community](https://twu.discourse.group/auth/microsoft_office365){target="_blank"} in Learning Community.
:::
...
-   Watch [The Matrix - 'I Know Kung Fu'](https://www.youtube.com/watch?v=0YhJxJZOWBw){target="_blank"} [-@clipsbluMatrixKnowKung2019]
...
::: {.learning-activity time="30"}
-   Watch [*Mind Mapping in Obsidian Canvas*](https://www.youtube.com/watch?v=eHI-Szjpafk){target="_blank"} [-@zhaoMindMappingObsidian2023]. As you watch, follow the directions and to create a concept map in Obsidian. At the end of this unit, you will create a concept map for Units 1-3. Practice using notes, media, cards, and grouping features in a mind map.
...
-   Read the following articles and take notes in Obsidian. Try using Markdown to format your text.
    -   [*Effective Reading and Note-Taking*](https://www.student.unsw.edu.au/effective-reading-and-note-taking){target="_blank"} [-@universityofnewsouthwalessydneyEffectiveReadingNotetaking]
    -   [*Reading for Understanding: The SQW3R Method*](https://www.student.unsw.edu.au/reading-understanding){target="_blank"} [-@universityofnewsouthwalessydneyReadingUnderstandingSQW3R2024]
    -   [*Using Markdown in Obsidian*](https://help.obsidian.md/Editing+and+formatting/Basic+formatting+syntax){target="_blank"} [-@obsidianhelpBasicFormattingSyntax]
:::
...
Reflect on your progress in practicing these digital skills. Share your thoughts in your journal and/or in Learning Community.
:::
...
-   Search for the following apps or websites using the key words listed below. Try adding "top," "best," "free," "university," or "students" and see how that changes your search results.
    ...
    -   research tools
    -   writing tools
-   In Learning Community, share some tools that you've used or that you plan to use to help in your studies.
:::
...
-   [*Mind Mapping*](https://subjectguides.york.ac.uk/note-taking/mind-map){target="_blank"} [-@universityofyorkMindMapping2024]
-   [*Getting Started with Obsidian Canvas*](https://obsidian.rocks/getting-started-with-canvas-in-obsidian/){target="_blank"} [-@GettingStartedObsidian2024]
