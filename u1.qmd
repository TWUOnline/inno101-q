---
title: "Introduction To Digital Literacies for Online Learning"
---
...
Please note that we will invite you to sign up for some web-based tools (LitMaps, Zotero) and we hope you will feel comfortable doing that. We have vetted and personally use the tools we recommend here. If you are uncomfortable signing up, please let your facilitator or instructor know and we will be happy to talk about options, including signing up anonymously. You will not have to pay for any of the tools that we suggest.
...
::: {#fig-image1}
![](assets/u1/3.%20LDRS%20101_Overview.png){.lightbox fig-alt="Overview of the Structure of the Course: Learning with Technology" fig-align="left" width="800"}

Overview of the Structure of the Course: Learning with Technology
:::
...
-   Reflect on your learning goals and make a plan for meeting them. 
-   Work through the *Learner* section of *Liberated Learners: How To Learn With Style* and create a list of your top ten study tips for online learning. 
-   Read *Students' Engagement in Asynchronous Online Discussion: The Relationship Between Cognitive Presence, Learner Prominence, and Academic Performance* [-@galikyanStudentsEngagementAsynchronous2019] and consider the benefits of engaging online 
-   Write an introduction post on the Learning Community in Learning Community. 
-   Watch The Future of Education is Self-Directed Learning and consider what tools and literacies you want to explore to meet your goals. 
-   Download and install Obsidian and follow the instructions for the LDRS 101 vault. 
-   Explore definitions of digital literacy. 
-   Watch the video on Reflecting on the Promise of Technology and refine your goals. 
-   Take a self-assessment on your digital literacy skills. 
-   Watch Visitors and Residents [-@whiteVisitorsResidents2014] to start thinking about where you reside on the web. 
-   Create a Visitors and Residents diagram. 
-   Get a password manager. 
-   Use the *Terms of Service: Didn't Read* [-@tosdrTermsServiceDidnt] website to look up each of the apps we will learn in this course. 
<!-- -   Write an introduction post on [the Learning Hub](https://twu.Learning Community.group){target="_blank"} in Learning Community. 
-   Watch The Future of Education is Self-Directed Learning and consider what tools and literacies you want to explore to meet your goals. 
-   Download and install [Obsidian](https://obsidian.md){target="_blank"} and follow the instructions for the LDRS 101 vault. 
-   Explore definitions of digital literacy. 
-   Watch the video on Reflecting on the Promise of Technology and refine your goals. 
-   Take a self-assessment on your digital literacy skills. 
-   Watch Visitors and Residents (2014) to start thinking about where you reside on the web. 
-   Create a Visitors and Residents diagram. 
-   Get a password manager. 
...
-   Watch the video on Reflective Journaling. 
...
-   In this unit, you will be introduced to a note-taking tool that includes a template to help you track your progress throughout the course.
...
Online learning requires additional skills differing from face-to-face learning, and since online learning is often self-paced, an absence of these skills will make a student's learning experience difficult. According to Crozier and Lake [-@crozierLearningLearnOnline2020] these skills include:
...
::: {#fig-image2}
![](assets/u1/4.%20LDRS%20101_Learning%20online.png){.lightbox fig-alt="Tips for Successful Online Learning" fig-align="left" width="500"}
...
-   Take some time to work through [The Learner](https://ecampusontario.pressbooks.pub/learner/part/learner/){target="_blank"} [-@greeneLearner2022]. It begins with a short video and includes activities that you can complete. These are for your reflection.
...
### Activity: Engaging in Online Discussions

:::: {.learning-activity time="30"}
Participating in discussions with your peers (what higher education folks like to call *Learning Community*---a verb), is an essential aspect of effective online courses, facilitated through platforms such as Moodle discussion forums, WordPress blogs, Learning Community posts (in this case, a noun---referring to the app called Learning Community), and others. We all know that discussion forums can sometimes be tedious, especially when they are assessed in the same way a formal paper is assessed. However, the benefits of using asynchronous technologies (where your interactions with others are time-delayed) in well-designed activities can be significant.

Here is an article that will introduce you to some key ideas about discussion forums:

-   [*Students' Engagement in Asynchronous Online Discussion: The Relationship Between Cognitive Presence, Learner Prominence, and Academic Performance*](https://www-sciencedirect-com.twu.idm.oclc.org/science/article/pii/S1096751619304105){target="_blank"} [-@galikyanStudentsEngagementAsynchronous2019]
...
In this course, we will ask you to discuss ideas with your peers via Learning Community, WordPress, and other social media platforms. These discussions are ***ungraded***, meaning, your instructor will ***not*** give you marks per discussion. ***However,*** they are an important part of this course and ***you will not be able to complete your assignments without discussing with your peers***. Consider for example, two course learning outcomes that relate to online discussions:
...
In LDRS 101, you should write your posts in a way that shows you are communicating in an academic setting. While you don't need to adhere to all of the conventions of APA formatting, you should practice the principles of proper citation. For example, to cite an idea from the article in the previous activity, it would look like the following [@galikyanStudentsEngagementAsynchronous2019], and the bottom of the post would include a "References" heading, followed by the full reference (this part may be considered optional since we have included a link to the article in the in-text citation, but it is nice to have). Please consult the [APA Style website](https://apastyle.apa.org/style-grammar-guidelines){target="_blank"} for details.

It is ***highly*** recommended that you begin using a reference manager---we recommend Zotero as it is a free and open source app with all you will ever need to cite properly in any style. We will lead you through some specifics of using Zotero in the next unit of LDRS 101, but you can [download Zotero](https://www.zotero.org/){target="_blank"} for free.
...
For more on substantive participation, read [*Writing a Substantive Discussion Post for an Online Class Forum*](https://apuedge.com/writing-a-substantive-discussion-post-for-an-online-class-forum/){target="_blank"} [-@pateteWritingSubstantiveDiscussion2016].

### Activity: Join the TWU Learning Community!

The Learning Community is a critical component of online courses at TWU because it provides a single space for you to connect with your facilitators, instructors, and, most importantly, other learners completing this and other online courses at TWU. Your privacy is protected as you will be signing in through TWU systems.

You will notice that you see categories for other courses when you sign in. This is intentional because we want you to be able to connect with a wide variety of learners in a wide variety of courses. This structure also allows you to discuss topics that span multiple courses, such as '#leadership'. You are welcome to explore other course categories and to consider Learning Community as your digital campus.

::: {.learning-activity time="20"}
Head over to [the Learning Community](https://twu.discourse.group/auth/microsoft_office365){target="_blank"}, which is an app called Discourse that we use to build community among learners in online courses. Find the Leadership 101 category and respond to the Welcome forum. As you introduce yourself, share your thoughts and questions you have about TWU. Here are some conversation prompts to get you started:
...
[Watch: *The Future of Education is Self-Directed Learning*](https://www.youtube.com/watch?v=NkmiquiJ_nA){target="_blank"} [-@staffordFutureEducationSelfdirected2024]
...
> Digital literacy is a person's knowledge, skills, and abilities for using digital tools ethically, effectively, and within a variety of contexts in order to access, interpret, and evaluate information, as well as to create, construct new knowledge, and communicate with others. [@britishcolumbiaministryofeducationBCsPostsecondaryDigital, p. 23]
...
> "In today's world, being literate requires much, much more than the traditional literacy of yesterday." [@alberDeeperLearningDefining2013]

What digital tools do you use to help you make meaning? What is your "go-to" app for note taking, organizing files, tracking references, and connecting ideas? One valuable tool we are going to show you is called Obsidian, a free note taking and mind mapping app. Before you go through the instructions in the activity below, watch the video *This is Obsidian*.

[Watch: *This is Obsidian*](https://www.youtube.com/watch?v=d2FNqEDGc8g){target="_blank"} [-@birchlerThisObsidian2021] <!-- Auto title, auto embed-->
...
Obsidian is the first tool that we will ask you to use that requires you to download a program and install it on your computer. As you work through the instructions for installing Obsidian and getting started with the starter vault, keep in mind that you will almost certainly encounter things that don't work in the way that you expect them to, or that don't seem to match the instructions. That is ok, and it is important for you to not get discouraged. We know that you likely don't know how to do some of these things, and that is the whole point of you taking a course...to learn things! The almost universal *feeling* when people are learning something new is frustration. Do not feel bad about feeling frustrated. Instead, go back and check the instructions to see if there was something you missed. If that does not reveal anything in a couple tries, please reach out in the Learning Community! We will direct you to resources and conversations where others who have gone before you have worked through all the same issues.

One of the most important things we can do in learning is to get things wrong, then reach out for help. 

:::: {.learning-activity time="30"}
Follow the steps below to install Obsidian on your computer. 

***Make sure you use the arrows to click through all seven steps!***
...
```{=html}
<!--
-  [Follow these instructions to install Obsidian on your computer.](https://help.obsidian.md/Getting+started/Download+and+install+Obsidian){target="_blank"}
...
If you are having any difficulty in installing Obsidian, feel free to reach out for support on [the Learning Community](https://twu.discourse.group/auth/microsoft_office365){target="_blank"}. There are also several tutorials and videos online; you are encouraged to seek out these resources. One example is [*Obsidian for Beginners: Start HERE --- How to Use the Obsidian App for Notes*](https://www.youtube-nocookie.com/embed/QgbLb6QCK88?si=ZKdRBBIccDy4TjgY){target="_blank"} (2020). The first minute shows how to set up Obsidian ... and if you'd like a sneak peek at the amazing features this tool has to offer, watch on! We'll get to these additional uses of Obsidian later in the course.
-->
```
::::

Obsidian will become a backbone of this course as we will use it to learn how the web works and give you a workflow that will help you stay organized. One of the advantages of Obsidian is that everything you do in the app happens on your own computer, rather than the cloud, which is just another way of saying *someone else's computer*. However, the drawback to that is that you need to ensure that you have a backup of your vaults in a secure location, either one of the sync services mentioned in Step 3, above, or another backup system. [Please check the Learning Community](https://twu.discourse.group/auth/microsoft_office365){target="_blank"} or talk to your instructor or facilitator for help with this.

::: note
*Note:* For your assignments, you may choose a tool other than Obsidian.  However, you will need to demonstrate all the required elements (tagging, hyperlinking, file management, citation management integration, graphic organizers, etc.) to demonstrate your proficiency in building a technology-integrated workflow. You are strongly encouraged to try out Obsidian and take the time to practice using its various features. Feel free to test out other tools and decide what tool best supports your workflow.
:::
...
### Activity: Reflection on the Evolution of Digital Technologies
...
[Watch: *The Evolution of Digital Technology*](https://www.youtube.com/watch?v=PdqWlByz-NQ){target="_blank"} [-@realeducationEvolutionDigitalTechnology2024]<!-- (2010)-->
...
**Using 'Today's Daily Note' in Obsidian**

If you don't have a folder called 'Notes' in your vault, add a folder by clicking the folder icon. Rename the folder as Notes.

Next, click “Open Today’s Daily Note” (the circled icon that looks like a calendar in @fig-tdn) in your Obsidian vault and write your reflections.

This is the start of your reflective learning journal that you will continue to add to throughout the course.

::: {#fig-tdn}
![](assets/u1/tdn_v2.png){.lightbox fig-alt="Screenshot, Obsidian, today's daily note icon circled" fig-align="left"}

Screenshot, Obsidian, Where to Find Today's Daily Note (Icon Circled)
:::

-   Style your text using Markdown codes. [Click here for the basic Markdown syntax](https://help.obsidian.md/Editing+and+formatting/Basic+formatting+syntax){target="_blank"} [@obsidianhelpBasicFormattingSyntax].
...
Digital literacies for academic learning involves more than Facebook, Snapchat, or BlueSky and the associated technical skills in using these technologies.
...
-   Read [Wikipedia's definition](https://en.wikipedia.org/wiki/Digital_literacy){target="_blank"} [-@DigitalLiteracy2024] of digital literacy---is this a good description?
...
Next, read the [*Quick Guide - Developing Students' Digital Literacy*](assets/u1/JISC_REPORT_Digital_Literacies_280714_PRINT.pdf){target="_blank"} [-@jiscdigitalexperienceinsightsQuickGuideDeveloping]

This guide defines digital literacies as "the capabilities which fit an individual for living, learning and working in a digital society" [@jiscdigitalexperienceinsightsQuickGuideDeveloping]. Furthermore, this report distinguishes between seven elements of digital literacies:
...
*Source.* From "[*Quick Guide - Developing Students' Digital Literacy*](https://digitalcapability.jiscinvolve.org/wp/files/2014/09/JISC_REPORT_Digital_Literacies_280714_PRINT.pdf){target="_blank"}," by Jisc Digital Experience Insights, [-@jiscdigitalexperienceinsightsQuickGuideDeveloping], p. 2. CC BY-NC-ND 2.0 UK<!-- https://creativecommons.org/licenses/by-nc-nd/2.0/uk/-->.

**Questions to Consider** 

Create a new entry in your Obsidian learning journal. Jot down your reflections on the following:

- What are your thoughts on the seven elements of digital literacies? 
- Are these key literacies you need to live, learn, and work in today's society? 
- What would you add to the list?
- In your search to define digital literacies, what other literacies or skills are emphasized? 
- What would your list be for digital literacies that are important for you?

Feel free to share your thoughts and experiences by posting on the LDRS 101 Learning Community chat. For example:
...
This learning activity will provide you with another opportunity to connect with your peers in Learning Community and contribute to online learning discussions.
...
-   [Watch: *Digital Literacy and Why it Matters*](https://www.youtube.com/watch?v=p2k3C-iB88w){target="_blank"} [-@universityofderbyDigitalLiteracyWhy2014]
...
-   Go to the LDRS 101 section in Learning Community
...
-   Use the [Digital Literacy Self-Assessment Tool](https://thinkspace.csu.edu.au/digitalcitizenshipguideetl523/){target="_blank"} [-@papasDigitalCitizenshipGuide2020] from the Digital Citizenship Guide

<!-- //todo  #31 Alternatively, you can choose from these resources: -->

<!-- -   Take the [Digital Literacy Self-Assessment](https://www.supportedemployment.ca/digital-literacy/digital-literacy-self-assessment/){target="_blank"} [-@canadianassociationforsupportedemploymentDigitalLiteracySelfassessment] from the Canadian Association for Supported Employment **or**-->

<!-- -   Explore the *What is Digital Literacy?* page of the [Digital Literacies Toolkit](https://www.elanguages.ac.uk/digital_literacies_toolkit.php){target="_blank"} [-@universityofsouthamptonDigitalLiteraciesToolkit] developed by the University of Southampton.-->
...
Share your thoughts by posting on the Learning Community.
:::
...
-   [Watch: *Visitors and Residents*](https://www.youtube.com/watch?v=sPOG3iThmRI){target="_blank"} [-@whiteVisitorsResidents2014]
...
### Activity: Create a Visitor and Resident Diagram
...
-   Read [*Visitors and Residents: A New Typology for Online Engagement*](https://firstmonday.org/ojs/index.php/fm/article/view/3171){target="_blank"} [-@whiteVisitorsResidentsNew2011]
-   Create a new canvas in your Obsidian vault and create your own Visitor--Resident Diagram. We have created a sample diagram in the vault called `VR Diagram Canvas`.
...
-   [**Identity theft**](https://en.wikipedia.org/wiki/Identity_theft){target="_blank"} [-@IdentityTheft2025] happens, frequently.
...
-   **Spam email [(at least half of all email being sent)](https://securelist.com/spam-phishing-report-2023/112015/){target="_blank"}** is an unfortunate fact of our modern lives.
...
*Source* From "Are Your Passwords in the Green in 2023?," by C. Nesky, [-@neskeyAreYourPasswords2023], *Hive Systems* (https://www.hivesystems.com/blog/are-your-passwords-in-the-green-2023). Copyright 2024 [Hive Systems](https://www.hivesystems.com/){target="_blank"}. Reprinted with permission.
...
Get a [password manager](https://en.wikipedia.org/wiki/Password_manager){target="_blank"} [-@PasswordManager2025]. They are incredibly helpful and convenient now that many of us use several computers and mobile devices. Password managers help you manage your passwords.
...
1.  Read [*How to Start Using a Password Manager*](https://www.makeuseof.com/how-to-start-using-password-manager/){target="_blank"} [-@stegnerHowStartUsing2021].
...
[Watch: *Reflective Writing*](https://www.youtube.com/watch?v=QoI67VeE3ds){target="_blank"} [-@skillsteamuniversityofhullReflectiveWriting2014]
...
### Activity: Journal Entry on Digital Literacies
...
::: {#fig-obsidian1}
![](assets/u1/obsidian1.png){.lightbox fig-alt="Screenshot showing where to find daily note icon in Obsidian" fig-align="left" width="340"}
...
<!-- <iframe src="https://create.twu.ca/h5p/wp-admin/admin-ajax.php?action=h5p_embed&amp;id=651" width="958" height="549" frameborder="0" allowfullscreen="allowfullscreen" title="Unit 1 Progress Check">
