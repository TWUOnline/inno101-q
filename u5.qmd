...
-   Read *Global Citizenship Education* [-@GlobalCitizenshipEducation2024] and *John Dewey Would Hate Your Digital Citizenship Curriculum* [-@JohnDeweyWould2016] and write your personal definition of a digital citizen.
-   Listen to the podcast on *Digital Citizenship* [-@stachowiakDigitalCitizenshipAudio2016].
-   Read *Nine Elements of Digital Citizenship* [-@digitalcitizenshipNineThemesDigital2023] and apply elements to your academic study.
...
Work through the resources in [What is Digital Citizenship?](https://mediasmarts.ca/digital-media-literacy/general-information/digital-media-literacy-fundamentals/what-digital-citizenship){target="_blank"} from Media Smarts: Canada's Centre for Digital Media Literacy
...
-   **Online search:**
    -   Read the introductory section of the Wikipedia article [*Digital Citizen*](https://en.wikipedia.org/wiki/Digital_citizen){target="_blank"} [-@DigitalCitizen2024a].
...
-   **Read and identify:**
    -   Read [*Nine Themes of Digital Citizenship*](https://www.digitalcitizenship.net/nine-elements.html){target="_blank"} [-@digitalcitizenshipNineThemesDigital2023], and search for other academic articles on digital citizenship using Google Scholar, LitMaps, or the TWU Library.
...
:::: {.learning-activity time="60"}
-   [Watch: *Your Digital Rights and Responsibilities\| Being a Good Digital Citizen*](https://www.youtube.com/watch?v=QpNeavL0Dfw){target="_blank"}
...
-   First, scan the following resources:
    -   [*High Court Rules Public Servants can be Sacked for Political Social Media Posts*](https://www.theguardian.com/australia-news/2019/aug/07/high-court-rules-public-servants-can-be-sacked-for-political-social-media-posts){target="_blank"} [-@karpHighCourtRules2019a]
...
-   Watch the short video [Watch: *Using Twitter effectively in education - with Alec Couros*](https://www.youtube.com/watch?v=EqSCR3HU4eg){target="_blank"} [-@teachingandlearninginsouthaustraliaUsingTwitterEffectively2013]Couros summarizes how educators are using Twitter (now X) to connect professionally.

[Watch: *Using Twitter effectively in education - with Alec Couros*](https://www.youtube.com/watch?v=EqSCR3HU4eg){target="_blank"} [-@teachingandlearninginsouthaustraliaUsingTwitterEffectively2013]
<div class="video-container">
...
-   Create or update your professional profile on LinkedIn.
    -   Consult TWU's [*Student Resources* website](https://www.twu.ca/academics/academic-professional-support/centre-calling-career-development/students/student){target="_blank"} [-@StudentResources] which includes information about LinkedIn. TWU gives you access to LinkedIn Learning, which includes several great courses and videos, such as [*Rock Your LinkedIn Profile*](https://www.linkedin.com/learning/rock-your-linkedin-profile/connect-to-opportunity-with-linkedin?u=124451074){target="_blank"} [-@RockYourLinkedIn].
...
> A community of practice is a group of people who *"share a concern or a passion for something they do and learn how to do it better as they interact regularly."* [@wenger-traynerIntroductionCommunitiesPractice2022]
...
Wenger-Trayner [-@wenger-traynerIntroductionCommunitiesPractice2022] argues that a community of practice is different from a community of interest or a geographical community in that it involves a shared practice: ways of doing things that are shared to some significant extent among members.

#### Characteristics of a Community of Practice {.unnumbered}

According to Wenger-Treyner [-@wenger-traynerIntroductionCommunitiesPractice2022] there are three crucial characteristics of a community of practice:
...
-   [*Jottings in the Margins - Using Digital Annotation to Support 21st Century Learning*](https://www.thescopes.org/assets/scopes/SCOPE_104-Wood_LT9.pdf){target="_blank"} [-@woodJottingsMarginsUsing2020a]
:::
...
-   Read the Hypothes.is [*Quick-Start Guide for Students*](https://web.hypothes.is/quick-start-guide-for-students/){target="_blank"} [-@StudentResourceGuide] and create an account on Hypothes.is. We recommend that you use the Chrome browser and install the Hypothes.is extension. Alternatively, you can annotate web pages directly from the Hypothes.is website by pasting the link into the text area after you have logged into the site. If you are working on a mobile device, please follow these instructions: [*How to use Hypothes.is on Mobile Devices*](https://web.hypothes.is/help/how-to-use-hypothesis-on-mobile-devices/){target="_blank"} [-@HowUseHypothesis].
...
-   Read [*Social Media for Learning*](https://www.shu.ac.uk/digital-skills/personal/social-media-for-learning){target="_blank"} [-@UsingSocialMediaa]
-   Watch [*Building More Creative Social Networks*](https://www.youtube.com/watch?v=Acc4zY1sQ0o){target="_blank"} [-@universityofrochesterBuildingMoreCreative2020a]
...
-   Check out [*The Conversation Prism*](https://www.briansolis.com/2008/08/introducing-conversation-prism-html/){target="_blank"} [-@solisIntroducingConversationPrism2008a] and also refer to the graphic below listing numerous apps for listening, learning, and adapting (click the graphic to enlarge).
...
Finally, take a look at Trinity's [*Life at TWU*](https://www.twu.ca/life-twu){target="_blank"} [-@LifeTWU] website.
