...
<iframe src="https://create.twu.ca/h5p/wp-admin/admin-ajax.php?action=h5p_embed&amp;id=646" width="675" height="535" frameborder="0" allowfullscreen="allowfullscreen" title="Getting Started With Obsidian">
...
[Watch: *Inquiry-Rich Learning*](https://www.youtube.com/watch?v=SCa9Nt3X1vU){target="_blank"} [-@trinitywesternuniversityInquiryrichLearning2018] <!-- Auto title, auto embed-->
...
### Activity: Visualizing Your Personal Learning Environment?
...
-   Next, create a graphic organizer to visualize your PLE. You can use Obsidian, or see [*Best Graphic Organizers for Education*](https://www.techlearning.com/news/best-graphic-organizers-for-education){target="_blank"} [-@restifoBestGraphicOrganizers2023] for other free options.
...
We are here to help you create your site, so do not hesitate to ask for technical support. There are a number of resources below, but if you get stuck, please reach out for support.

To get started on creating your site we suggest the following steps:

Tip: Click the ⛶ fullscreen icon to make the presentation fullscreen.

<iframe src="https://create.twu.ca/h5p/wp-admin/admin-ajax.php?action=h5p_embed&id=652" width="809" height="582" frameborder="0" allowfullscreen="allowfullscreen" title="Setting up your Learning Blog"></iframe><script src="https://create.twu.ca/h5p/wp-content/plugins/h5p/h5p-php-library/js/h5p-resizer.js" charset="UTF-8"></script>
...
Reflect on creating your blog in a new post. Save your work as a draft so you can review before publishing. 
   You might:
...
4. **Video Challenge** (Optional)

If you’d like, record a short video introduction and embed it in your blog post. You can also share a relevant video you found online. See the resources section for instructions on embedding videos in WordPress.
...
-   [*TWU's WordPress Support Page*](https://servicehub.twu.ca/TDClient/1904/Portal/KB/ArticleDet?ID=146597){target="_blank"}[@trinitywesternuniversityWordpressBlockEditor2022]
-   [*WordPress Support Guides*](https://wordpress.com/support/){target="_blank"}[@wordpressWordPressSupportGuides]
-   [*Start Here: WordPress Beginner*](https://www.wpbeginner.com/start-here/){target="_blank"} [-@balkhiStartHereYour2016]
-   [*WordPress Tutorials; University of Victoria*](https://onlineacademiccommunity.uvic.ca/wordpress-tutorials/){target="_blank"}[-@universityofvictoriaWordPressTutorials]
- [How to Add Featured Images in WordPress](https://www.youtube.com/watch?v=9admKGpM3A0){target="_blank"} [-@wpbeginnerHowAddFeatured2017]
- *[WordPress How to Add Video to a Page or Post](https://www.youtube.com/watch?v=3hCMpnok2Kw){target="_blank"}* [-@createwpsiteWordPressHowAdd2021]
...
If you are confused about anything it is always good to do an initial Google or YouTube search, reach out on Discourse, or email [elearning@twu.ca](mailto:elearning@twu.ca){target="_blank"}
...
In the next activity, you will gain firsthand experience in using blog technology for publishing your own website. You will "declare" yourself online using your PLE as an alternative to posting an introduction in a closed course forum typically used in a conventional online course. Note that online courses at TWU often use Moodle Discussion Forums to facilitate conversations. By using a platform such as WordPress you can retain the contents of your posts as well as the comments of your peers. In a learning management system (LMS) such as Moodle you may lose access to what you have posted in discussions, and more importantly, conversations with your peers. As you create your personal blog in WordPress (or your own selective blog site), you control your data and who can see it.
...
-   **Choose a photo** to add to your blog post. Be sure you have permission to upload the photo. We suggest using an open license site such as [Pixabay](https://pixabay.com/){target="_blank"}, [Unsplash](https://unsplash.com/){target="_blank"}, [Pexels](https://www.pexels.com/){target="_blank"}, [Wikimedia Commons](https://commons.wikimedia.org/wiki/Main_Page){target="_blank"}, or [Flickr](https://www.flickr.com/search/?text=pho&license=2%2C3%2C4%2C5%2C6%2C9){target="_blank"}. Alternatively, upload your own photo, take a selfie, or ask someone to take a photo of you working on this blog post challenge. You might find the following videos helpful:
    -   [*How to Add an Image to a WordPress Website*](https://www.youtube.com/watch?v=W89wPcVU60c){target="_blank"} [-@wpventureHowAddImage2017]
    -   [How to Add Featured Images in WordPress](https://www.youtube.com/watch?v=9admKGpM3A0){target="_blank"} [-@wpbeginnerHowAddFeatured2017]
...
[Watch: *WordPress How To Add Video To A Page Or Post*](https://www.youtube.com/watch?v=3hCMpnok2Kw){target="_blank"} [-@createwpsiteWordPressHowAdd2021]
...
-   Post in the LDRS 101 Learning Community forum to let your peers know the web address of your blog and ask them to post a comment. This will give you the opportunity to experience how comments function on your blog and to test if they are working properly.
:::
...
-   [*TWU's WordPress Support Page*](https://servicehub.twu.ca/TDClient/1904/Portal/KB/ArticleDet?ID=146597){target="_blank"}[@WordpressBlockEditor2022]
-   [*WordPress Support Guides*](https://wordpress.com/support/){target="_blank"}[@wordpressWordPressSupportGuides]
-   [*Start Here: WordPress Beginner*](https://www.wpbeginner.com/start-here/){target="_blank"} [-@balkhiStartHereYour2016]
-   [*WordPress Tutorials; University of Victoria*](https://onlineacademiccommunity.uvic.ca/wordpress-tutorials/){target="_blank"}[-@universityofvictoriaWordPressTutorials]

::: note
-   If you are confused about anything it is always good to do an initial Google or YouTube search, reach out on Learning Community, or email elearning\@twu.ca
:::
:::
...
-   [*Understanding Your Online Identity*](assets/u4/U4_Understanding-your-Online-Identity-An-Overview-of-Identity.pdf){target="_blank"} [-@internetsocietyUnderstandingYourOnline2017]
-   [*How To Manage Your Digital Footprint in 2025: 20 Tips for Students*](https://research.com/education/how-to-manage-digital-footprint){target="_blank"} [-@bouchrikaiHowManageYour2025]
...
Reminder: As you view online resources in this course, feel free to annotate and discuss web resources publicly in support of your learning (e.g., using digital tools such as Hypothes.is, Learning Community, WordPress, or others).
:::
...
-   Watch [*Four Reasons to Care About Your Digital Footprint*](https://www.youtube.com/watch?v=Ro_LlRg8rGg){target="_blank"} [-@internetsocietyFourReasonsCare2016].
...
-   [*Students Turn to Internet to Build Online Presence, Showcase Work*](https://www.huffpost.com/entry/students-turn-to-internet_b_3518598){target="_blank"} [-@friedmanj.StudentsTurnInternet2013]
-   [*Your Online Presence and Your Career*](https://help.open.ac.uk/your-online-presence){target="_blank"} [@theopenuniversityYourOnlinePresence]
-   [*Digital Tattoo Project*](https://digitaltattoo.ubc.ca/){target="_blank"} [-@theuniversityofbritishcolumbiaDigitalTattooProject]
-   [*Policy Brief: Privacy*](https://www.internetsociety.org/policybriefs/privacy/){target="_blank"} [-@internetsocietyPolicyBriefPrivacy2015]
...
-   [*Amazing Mind Reader Reveals his 'Gift'*](https://www.youtube.com/watch?v=F7pYHN9iC9I){target="_blank"} [-@guillaumeAmazingMindReader2012]
...
::: {.learning-activity time="60"}
-   Read the following [Tool Evaluation Criteria](https://workforceedtech.org/tool-evaluation-criteria/){target="_blank"} [-@edtechcenterToolEvaluationCriteria]. Note some criteria may not apply to the tool you choose to evaluate. Also see the [Tool Evaluation Scoring Rubric and Notepad](https://docs.google.com/spreadsheets/d/1-zIw01FI0N6NKY2SdOO2PuniUxDxAG-beeTsmxRQru0/edit?usp=sharing/){target="_blank"} (an editable Google Sheet).
...
Recall in Unit 1 you explored the website [*Terms of Service. Didn't Read*](https://tosdr.org/){target="_blank"}. You may want to use this tool for this activity to look up some common tech examples and see their score.
...
On Learning Community, let us know what tool you selected and why. Share the link of your review blog.
:::
