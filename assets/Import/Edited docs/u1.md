# Unit 1: Introduction to Digital Literacies for Online Learning
...
-   Write an introduction post on [the Learning Hub](https://twu.discourse.group) in Discourse.
...
-   Use the *[Terms of Service: Didn’t Read](https://tosdr.org/)* [@274] website to look up each of the apps we will learn in this course.
...
-   **Watch**: To give you some idea of what life is like at TWU, and why people choose TWU, watch the following video: [*Discover Undergraduate Studies at Trinity Western University*](https://youtu.be/Xlqpgb_3cR4?feature=shared) [@1940].

<https://www.youtube-nocookie.com/embed/Xlqpgb_3cR4>
...
### 1.0.2 Activity: Join the Hub!

::: reflect

Head over to [the Learning Hub](https://twu.discourse.group), which is an app called Discourse that we use to build community among learners in online courses. Find the Leadership 101 category and respond to the Welcome forum. As you introduce yourself, share your thoughts and questions you have about TWU.
...
Online learning requires additional skills differing from face-to-face learning, and since online learning is often self-paced, an absence of these skills will make a student’s learning experience difficult. According to Crozier and Lake [@185] these skills include:
...
-   **Watch**: [*Learning Online: Student Tips for Success*](https://vimeo.com/493206161) [@582]

<https://vimeo.com/493206161>

### 1.1.1 Activity: Learning Online Effectively

::: reflect

There are thousands of websites that offer advice such as “tips for online learning” or “how to succeed in your online class,” and some of those sites are good (see [here](https://www.purdueglobal.edu/blog/online-learning/online-learning-self-motivation/), [here](https://www.ualberta.ca/current-students/academic-success-centre/resources/working-online.html), [here](https://online.umn.edu/story/15-tips-succeed-online-class), and [here](https://www.trentu.ca/online/student-support/be-a-successful-online-learner) ). Some of them are also connected to shady people who want less than your best interests. One of the shining examples of a great resource is the *Liberated Learner* project, which was created primarily by university and college students like you. There are four main sections in the *Liberated Learner* resource—we will explore “The Learner” in this activity.

-   **Read**: Take some time to work through [The Learner](https://ecampusontario.pressbooks.pub/learner/part/learner/) [@1941]. It begins with a short video and includes activities that you can complete. These are for your reflection.
...
### 1.1.2 Activity: Online Discussions
...
-   [*Students’ Engagement in Asynchronous Online Discussion: The Relationship Between Cognitive Presence, Learner Prominence, and Academic Performance*](https://twu.idm.oclc.org/login?url=https://search.ebscohost.com/login.aspx?direct=true&db=edselp&AN=S1096751619304105&site=eds-live&scope=site) [@182]

Note: You may need to sign in to the TWU library to access this article. [You can find help here.](https://libguides.twu.ca/help)
...
In LDRS 101, you should write your posts in a way that shows you are communicating in an academic setting. While you don’t need to adhere to all of the conventions of APA formatting, you should practice the principles of proper citation. For example, to cite an idea from the article in the previous activity, it would look like the following (Galikyan & Admiraal, 2019), and the bottom of the post would include a “References” heading, followed by the full reference (this part may be considered optional since we have included a link to the article in the in-text citation, but it is nice to have). Please consult the [APA Style website](https://apastyle.apa.org/style-grammar-guidelines) for details.

It is ***highly*** recommended[^1] that you begin using a reference manager—we recommend Zotero as it is a free and open source app with all you will ever need to cite properly in any style. We will lead you through some specifics of using Zotero in the next unit of LDRS 101, but if you want to get started, you can [download Zotero](https://www.zotero.org/) for free.
...
For more on substantive participation, read *[Writing a Substantive Discussion Post for an Online Class Forum](https://apuedge.com/writing-a-substantive-discussion-post-for-an-online-class-forum/)* [@584].

### 1.1.3 Activity: Start a Conversation!

::: reflect

-   **Discuss**: Head over to [the Learning Hub](https://twu.discourse.group) on Discourse and find the *Leadership 101* category. Start a conversation about one of the following (or something else relevant):
...
## 1.3 Digital Literacies

> Digital literacy is a person’s knowledge, skills, and abilities for using digital tools ethically, effectively, and within a variety of contexts in order to access, interpret, and evaluate information, as well as to create, construct new knowledge, and communicate with others. [@180, page 23 ]
...
> “In today’s world, being literate requires much, much more than the traditional literacy of yesterday.” [@179]

What digital tools do you use to help you make meaning? What is your “go-to” app for note taking, organizing files, tracking references, and connecting ideas? One valuable tool we are going to show you is called Obsidian, a free note taking and mind mapping app. Before you go through the instructions in the activity below, watch the video [*This is Obsidian*](https://www.youtube.com/watch?v=d2FNqEDGc8g). [@586].

<https://www.youtube-nocookie.com/embed/d2FNqEDGc8g>

### 1.3.1 Activity: Getting Started With Obsidian

::: reflect

Follow the steps below to install Obsidian on your computer.

-   Go to [obsidian.md](https://obsidian.md/download) and [follow these instructions to install Obsidian on your computer.](https://help.obsidian.md/Getting+started/Download+and+install+Obsidian)
...
-   Work through the **Getting Started** section of the Obsidian help pages starting with [**Create a vault**](https://help.obsidian.md/Getting+started/Create+a+vault).
...
-   It is recommended that you [use one of the sync services listed here](https://help.obsidian.md/Getting+started/Sync+your+notes+across+devices) so that your files are backed up.

If you are having any difficulty in installing Obsidian, feel free to reach out for support on [the Learning Hub](https://twu.discourse.group/c/ldrs101/10). There are also several tutorials and videos online; you are encouraged to seek out these resources. One example is [*Obsidian for Beginners: Start HERE — How to Use the Obsidian App for Notes*](https://www.youtube.com/watch?v=QgbLb6QCK88) [@588]. The first minute shows how to set up Obsidian … and if you’d like a sneak peek at the amazing features this tool has to offer, watch on! We’ll get to these additional uses of Obsidian later in the course.

:::

Obsidian will become a backbone of this course as we will use it to learn how the web works and give you a workflow that will help you stay organized. One of the advantages of Obsidian is that everything you do in the app happens on your own computer, rather than the cloud, which is just another way of saying *someone else’s computer*. However, the drawback to that is that you need to ensure that you have a backup of your vaults in a secure location, either one of the sync services mentioned in Step 3, above, or another backup system. [Please check the Learning Hub](https://twu.discourse.group/c/ldrs101/10) or talk to your instructor or facilitator for help with this.

### 1.3.2 Activity: Download the Starter Vault
...
-   [Click this link to download the vault](https://github.com/twu-innovation/ldrs101-vault/archive/refs/heads/main.zip)
...
<img src="/Users/chloe.chang/Documents/GitHub/inno101-q/assets/Import/Edited docs/u1_assets/media/image1.png" style="width:3.19444in;height:2.27778in" />
...
<img src="/Users/chloe.chang/Documents/GitHub/inno101-q/assets/Import/Edited docs/u1_assets/media/image2.png" style="width:5.83333in;height:1.06358in" />
...
### 1.3.3 Activity: Reflection on the 21st Century Learner
...
-   [*Rethinking Learning: The 21st Century Learner*](https://www.youtube.com/watch?v=c0xa98cy-Rw) [@178]
...
<https://www.youtube-nocookie.com/embed/c0xa98cy-Rw>
...
<img src="/Users/chloe.chang/Documents/GitHub/inno101-q/assets/Import/Edited docs/u1_assets/media/image3.png" style="width:4.63889in;height:4.65278in" />

:::

-   Style your text using Markdown codes. [Click here for the basic Markdown syntax [@G2EVqfDM/zo0C2GGw].](https://help.obsidian.md/Editing+and+formatting/Basic+formatting+syntax)
...
### 1.3.4 Activity: Defining Digital Literacy
...
-   Read [Wikipedia’s definition](https://en.wikipedia.org/wiki/Digital_literacy) [@1947] of digital literacy—is this a good description?

-   Scan the [#diglit](https://twitter.com/i/flow/login?redirect_after_login=%2Fhashtag%2Fdiglit%3Fs%3D03) hashtag on X (Twitter)—did you find any valuable links to defining digital literacy?
...
-   Read [*What is Digital Literacy?*](http://pomo.com.au/blog/digital-literacy/) [@1945] by POMO—is this a reliable source?
...
### 1.3.5 Digital Literacies and Skills
...
### 1.3.6 Activity: What are Digital Literacies?
...
-   *[The Essential Elements of Digital Literacies](https://www.youtube.com/watch?v=A8yQPoTcZ78)* [@189]

<https://www.youtube-nocookie.com/embed/A8yQPoTcZ78>

-   **Read**: Next, read the *[Quick Guide - Developing Students’ Digital Literacy](https://digitalcapability.jiscinvolve.org/wp/files/2014/09/JISC_REPORT_Digital_Literacies_280714_PRINT.pdf)* [@G2EVqfDM/e6CYk5oE]*.*

This guide defines digital literacies as “the capabilities which fit an individual for living, learning and working in a digital society [@G2EVqfDM/e6CYk5oE, Introduction].” Furthermore, this report distinguishes between seven elements of digital literacies:
...
<img src="/Users/chloe.chang/Documents/GitHub/inno101-q/assets/Import/Edited docs/u1_assets/media/image4.png" style="width:5.83333in;height:3.77938in" />

*Note.* From “*Quick Guide - Developing Students’ Digital Literacy*,” by Jisc Digital Experience Insights, n.d., p. 2, (<https://digitalcapability.jiscinvolve.org/wp/files/2014/09/JISC_REPORT_Digital_Literacies_280714_PRINT.pdf>). [CC BY-NC-ND 2.0 UK](https://creativecommons.org/licenses/by-nc-nd/2.0/uk/).
...
### 1.3.7 Activity: Why Digital Literacy Matters
...
-   [*Digital Literacy and Why it Matters*](https://www.youtube.com/watch?v=p2k3C-iB88w) [@193]

<https://www.youtube-nocookie.com/embed/p2k3C-iB88w>
...
### 1.3.8 Activity: Am I Digitally Literate?
...
-   Take the [Digital Literacy Self-Assessment](https://www.supportedemployment.ca/digital-literacy/digital-literacy-self-assessment/) [@1949] from the Canadian Association for Supported Employment **or**

-   Use the [Digital Literacy Self-Assessment Tool](https://thinkspace.csu.edu.au/digitalcitizenshipguideetl523/) [@1951] from the Digital Citizenship Guide **or**

-   Explore the *What is Digital Literacy?* page of the [Digital Literacies Toolkit](https://www.elanguages.ac.uk/digital_literacies_toolkit.php) [@1953] developed by the University of Southampton.
...
At the same time, if we can imagine the visitor ↔ resident continuum on a horizontal axis, there is also a personal ↕ professional (or educational) continuum on a vertical axis, leading to four quadrants where you might situate your technology use.

### 1.3.10 Activity: Where am I Online?
...
-   [*Visitors and Residents*](https://www.youtube.com/watch?v=sPOG3iThmRI) [@194]

<https://www.youtube-nocookie.com/embed/sPOG3iThmRI>
...
<img src="/Users/chloe.chang/Documents/GitHub/inno101-q/assets/Import/Edited docs/u1_assets/media/image5.png" style="width:4.16667in;height:2.77778in" />
...
### 1.3.11 Activity: Visitor and Resident Diagram
...
-   [*Visitors and Residents: A New Typology for Online Engagement*](https://firstmonday.org/ojs/index.php/fm/article/view/3171) [@195]
...
## 1.4 Digital Privacy and Safety
...
-   **Spam email [(at least half of all email being sent)](https://securelist.com/spam-report-2019/96527/)** is an unfortunate fact of our modern lives.
...
<img src="/Users/chloe.chang/Documents/GitHub/inno101-q/assets/Import/Edited docs/u1_assets/media/image6.jpg" style="width:5.83333in;height:3.0625in" />

*Note*. From “Are Your Passwords in the Green in 2023?,” by C. Nesky, 2023, *Hive Systems* (https://www.hivesystems.com/blog/are-your-passwords-in-the-green-2023). Copyright 2024 [Hive Systems](https://www.hivesystems.com/). Reprinted with permission.
...
### 1.4.1 Activity: Get a Password Manager
...
-   **Read**: [*How to Start Using a Password Manager*](https://www.makeuseof.com/how-to-start-using-password-manager/) [@196].
...
-   Beware of the terms of service (ToS) of social media providers such as Facebook. Use a service such as *Terms of Service: Didn’t Read* ([TOSDR](https://tosdr.org/)) to help identify risky, overreaching services. You may be able to use certain privacy settings to protect your information.
...
-   [*Reflective Writing*](https://www.youtube.com/watch?v=QoI67VeE3ds) [@198]

<https://www.youtube-nocookie.com/embed/QoI67VeE3ds>
...
### 1.4.4 Activity: Digital Literacies for Online Learning
...
<img src="/Users/chloe.chang/Documents/GitHub/inno101-q/assets/Import/Edited docs/u1_assets/media/image7.png" style="width:4.75524in;height:7.14685in" />
