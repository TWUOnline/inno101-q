...
**What are your learning goals for this unit?**
- Describe each goal in your own words.

### My Learning Activity Checklist

Use the unit learning activity list and suggested time estimates to plan when you will complete each activity. 
...
After completing all unit learning activities, practice evaluative judgment by assessing your understanding of the unit and course learning outcomes. Regular self-assessment will deepen your learning and prepare you for assessment conversations with your instructor.

## Self-Assessment of Unit Learning Outcomes
...
>[!tldr] Take 5 minutes to reflect on what you learned in the unit.
>
...
>[!tldr] Consider your progress in understanding the course learning outcomes. At the end of Units 3, 5, and 6, you will be asked to submit assignments to demonstrate your proficiency in these areas:
...
After completing the unit learning activities, assess your ability to demonstrate your understanding of the Course Learning Outcomes. How would you categorize your overall proficiency in _**Learning with Technology**_?

<br> <label> <input type="radio" name="option" value=" Did not demonstrate"> Did not demonstrate </label> <br> <label> <input type="radio" name="option" value="Demonstrated emerging level of proficiency"> Demonstrated emerging level of proficiency </label> <br> <label> <input type="radio" name="option" value="Demonstrated developing level of proficiency"> Demonstrated developing level of proficiency </label> <br> <label> <input type="radio" name="option" value="Demonstrated proficient level of proficiency"> Demonstrated proficient level of proficiency </label> <br> <label> <input type="radio" name="option" value="Demonstrated extending level of proficiency"> Demonstrated extending level of proficiency </label> <br>
...
<label> <input type="radio" name="option" value=" Did not achieve goals"> Did not achieve goals </label> <br> <label> <input type="radio" name="option" value="Partially achieved goals"> Partially achieved goals </label> <br> <label> <input type="radio" name="option" value="Demonstrated developing level of proficiency"> Demonstrated developing level of proficiency </label> <br> <label> <input type="radio" name="option" value="Fully achieved goals"> Fully achieved goals </label> <br>
### Well done!

Feel free to share your progress with your facilitator or instructor for feedback.