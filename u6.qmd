...
Why is community so important to TWU, and how does it help us learn? Have a quick read about TWU's [Core Values](https://www.twu.ca/about-us/commitments/core-values){target="_blank"} [@CoreValues]. At this point in the course, we hope you have taken full advantage of the online community and have personal examples of how these interactions have impacted you.
...
-   Read [Social Learning in Online Environments](https://openpress.usask.ca/humanmooc/chapter/social-learning-in-online-environments/){target="_blank"} [@spellman-cannSocialLearningOnlinea] on how we learn in community.
...
> The theory and development of computer systems able to perform tasks normally requiring human intelligence, such as visual perception, speech recognition, decision-making, and translation between languages. [@oxfordreferenceArtificialIntelligence]
...
-   [10 Best AI Tools for Homework and Studying in 2024](https://mystudylife.com/10-best-ai-tools-to-help-students-learn-faster/){target="_blank"} [-@whantTop10AI2023]
...
-   [Watch: *Plagiarizing ChatGPT - Is it Illegal?*](https://www.youtube.com/watch?v=zuvN8_6QIKk){target="_blank"} [-@marklydaPlagiarizingChatGPTIt2022]
...
-   Read [*Collaborative Intelligence: Humans and AI are Joining Forces*](https://hbr.org/2018/07/collaborative-intelligence-humans-and-ai-are-joining-forces){target="_blank"} <!-- [@CollaborativeIntelligenceHumans]-->(2018).
-   Watch [AI Automation And The Future Of The Workforce](https://www.youtube.com/watch?v=NBLeWpOqhAo){target="_blank"} <!-- [@AIAutomationFuture]-->(2022)
...
-   Watch [The Terrifying Cost of "Free" Websites](https://www.youtube.com/watch?v=5pFX2P7JLwA){target="_blank"} <!-- [-@TerrifyingCostFree]-->(2016)
...
-   [Get Cyber Safe](https://www.getcybersafe.gc.ca/en){target="_blank"} [-@canadaGetCyberSafe2020] is a national public awareness campaign created to inform Canadians about cyber security and the simple steps they can take to protect themselves online.
-   [Protecting your information and data when using applications- ITSAP.40.200](https://www.cyber.gc.ca/en/protecting-your-information-and-data-when-using-applications-itsap40200){target="_blank"} [-@canadaProtectingYourInformation2023] from [Canadian Centre for Cyber Security](https://www.cyber.gc.ca/en){target="_blank"}
-   [*The Real Cost of the 'Free' Internet*](http://mediashift.org/2018/01/real-cost-free-internet/){target="_blank"} [-@RealCostFree2018]
...
-   [Sponsors' Participation in Conduct and Reporting of Industry Trials: A Descriptive Study](https://trialsjournal.biomedcentral.com/articles/10.1186/1745-6215-13-146){target="_blank"} [-@lundhSponsorsParticipationConduct2012a]
...
-   Read the following articles on the social media response to impersonation:
    -   [*Misleading and Deceptive Identities Policy (X)*](https://help.twitter.com/en/rules-and-policies/x-impersonation-and-deceptive-identities-policy){target="_blank"} [-@XsPlatformManipulation]
...
-   [Watch: *How To Spot a SCAM Email (8 Ways)*](https://www.youtube.com/watch?v=C5jIvj7EcqE){target="_blank"} (2022)
...
-   [*Your Photos can be Used in 'Catfishing' Romance Scams*](https://www.cbc.ca/radio/spark/380-phantom-traffic-jams-catfishing-scams-and-smart-speakers-1.4482967/your-photos-can-be-used-in-catfishing-romance-scams-1.4482985){target="_blank"} [-@YourPhotosCan]
-   [*Identity, Love, and Catfishing*](http://educationaltechnology.ca/2393/){target="_blank"} [-@alecIdentityLoveCatfishing2013]
-   [*Would the Real 'Alec Couros' Please Stand Up*](http://educationaltechnology.ca/2466/){target="_blank"} [-@alecWouldRealAlec2014]
...
-   [Watch: *How to Detect a Facebook Scammer With Google Reverse Image Search*](https://www.youtube.com/watch?v=s6Q4U8DvJH8){target="_blank"} [-@aleccourosHowDetectFacebook2014]
...
-   [*Facebook as Catfish Paradise: Its Community Standards Wears the Cone of Shame*](https://cogdogblog.com/2015/10/facebook-as-catfish-paradise-its-community-standards-wears-the-cone-of-shame/){target="_blank"} [-@blogFacebookCatfishParadise2015]
...
-   As you read the following, pay particular attention to strategies for dealing with trolling behaviour.
    ...
    -   [Internet Trolling: How do you Spot a Real Troll?](https://www.lifewire.com/what-is-internet-trolling-3485891){target="_blank"} [@moreauHereWhatYou2024]
-   Watch [The Secret Confessions of an Internet Troll](https://www.youtube.com/watch?v=5BQp3V_34BE){target="_blank"} [-@SecretConfessionsInternet]
...
-   Read the following articles and add or reply to annotations on Hypothes.is, focusing on how the research relates to your own online experience. Remember to tag your posts using the course code: LDRS101.
    -   ['Don't Feed the Trolls' Really is Good Advice -- Here's the Evidence](https://theconversation.com/dont-feed-the-trolls-really-is-good-advice-heres-the-evidence-63657){target="_blank"} [-@DontFeedTrolls]
...
> The Web as I envisaged it, we have not seen it yet. The future is still so much bigger than the past. [@mediumTimBernersLeeQuotes2023]<!-- (Tim Berners-Lee, 2009, as cited in Medium, 2023) -->
...
-   [*Strengthening Net Neutrality in Canada*](https://crtc.gc.ca/eng/internet/diff.htm){target="_blank"} [-@governmentofcanadaStrengtheningNetNeutrality2018]
...
-   [*Debating Bill C-11---Internet Censorship for Canadians*](https://www.youtube.com/watch?v=bmd4sASKFRw){target="_blank"} [-@lewisDebatingBillC112023]
...
-   [*Keystroke Logging*](https://en.wikipedia.org/wiki/Keystroke_logging){target="_blank"} [-@KeystrokeLogging2024a]
-   [*The Price of Connection: Surveillance Capitalism*](https://theconversation.com/the-price-of-connection-surveillance-capitalism-64124){target="_blank"} [-@couldryPriceConnectionSurveillance2016a] (surveillance capitalism)
-   [*How Bots Took Over Twitter*](https://hbr.org/2015/06/how-bots-took-over-twitter){target="_blank"} [-@HowBotsTook] (bot problems)
...
-   Read [How to Write a Notable Editorial](https://www.wikihow.com/Write-a-Notable-Editorial){target="_blank"} [-@posnerHowWriteNotable2024a].
...
-   Skim the following article in which the authors present a framework for digital wisdom, as well as practical practices that can help navigate the digital in our daily lives.
    -   [*A Framework for Digital Wisdom in Higher Education*](https://christianscholars.com/a-framework-for-digital-wisdom-in-higher-education/){target="_blank"} [-@paulusFrameworkDigitalWisdom2019a].
...
> Institutions of higher education have a crucial role and responsibility at this moment of technological change to form people who will flourish in our so-called digital age. [-@paulusFrameworkDigitalWisdom2019a, para. 1]
>
> Within the context of Christian higher education, the need to integrate new ICTs into our individual and institutional lives well and wisely---as we consider what technologies are doing to us and what we will do with them---is of utmost significance if we are committed to the cultivation of competence, character, and wisdom. [-@paulusFrameworkDigitalWisdom2019a, para. 6]
>
> Scripture enables us look behind and beyond our and others' online identities to see ourselves and others as embodied and relational beings made in the image of God. [-@paulusFrameworkDigitalWisdom2019a, para. 21]
>
> Our use of technologies must be shaped by our intentions and values, and we must be aware of how platform interfaces, permissions, algorithms, and other design elements could interfere with our goals and obligations. [-@paulusFrameworkDigitalWisdom2019a, para. 31]
