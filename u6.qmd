...
Share your thoughts on [Discourse](https://twu.discourse.group/){target="_blank"} or use Hypothes.is to annotate and share your comments.
:::
...
{{< video https://www.youtube-nocookie.com/embed/F57DE05FpgQ?si=0ST8TLfI3KwFoGNi >}}
...
-   Read [How to Write a Notable Editorial](https://www.wikihow.com/Write-a-Notable-Editorial){target="_blank"} [-@posnerHowWriteNotable2024a](2024).
...
-   Skim the following article in which the authors present a framework for digital wisdom, as well as practical practices that can help navigate the digital in our daily lives.
    -   [*A Framework for Digital Wisdom in Higher Education*](https://christianscholars.com/a-framework-for-digital-wisdom-in-higher-education/){target="_blank"} [-@paulusFrameworkDigitalWisdom2019a] (2019).
...
> Institutions of higher education have a crucial role and responsibility at this moment of technological change to form people who will flourish in our so-called digital age. [-@paulusFrameworkDigitalWisdom2019a, 2019, para. 1]
>
> Within the context of Christian higher education, the need to integrate new ICTs into our individual and institutional lives well and wisely---as we consider what technologies are doing to us and what we will do with them---is of utmost significance if we are committed to the cultivation of competence, character, and wisdom. [-@paulusFrameworkDigitalWisdom2019a, 2019, para. 6]
>
> Scripture enables us look behind and beyond our and others' online identities to see ourselves and others as embodied and relational beings made in the image of God. [-@paulusFrameworkDigitalWisdom2019a, 2019, para. 21]
>
> Our use of technologies must be shaped by our intentions and values, and we must be aware of how platform interfaces, permissions, algorithms, and other design elements could interfere with our goals and obligations. [-@paulusFrameworkDigitalWisdom2019a, 2019, para. 31]
...
>
> Every graduate is equipped to think truthfully, act justly, and live faithfully for the good of the world and the glory of God. [-@trinitywesternuniversityMissionVisionTrinity, 2025]

::: {.note}

*Notes:* Your Obsidian vault includes a template to help you track your progress in each unit. Use it to self-assess your understanding of the unit learning outcomes and ensure you’re on track to achieve your learning goals.
