...
:::: {.learning-activity time="20"}
[Watch: *What is the Future of Work?*](https://www.youtube.com/watch?v=EuDnSqAo784){target="_blank"} [-@worldeconomicforumWhatFutureWork2022] from the World Economic Forum.
...
-   As you read the following, pay particular attention to strategies for dealing with trolling behaviour.
    -   [Troll (Slang)](https://en.wikipedia.org/wiki/Troll_(slang)){target="_blank"} [@TrollSlang2024]
