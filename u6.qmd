...
Review TWU's policy on [*Academic Misconduct & Fraud*](https://www.twu.ca/about-us/policies-guidelines/university-policies/academic-misconduct-fraud){target="_blank"} [@AcademicMisconductFraud]. Is it academic fraud if you use Chat GPT to complete assignments?
...
-   Read [*Collaborative Intelligence: Humans and AI are Joining Forces*](https://hbr.org/2018/07/collaborative-intelligence-humans-and-ai-are-joining-forces){target="_blank"} [-@CollaborativeIntelligenceHumans].
-   Watch [AI Automation And The Future Of The Workforce](https://www.youtube.com/watch?v=NBLeWpOqhAo){target="_blank"} [-@AIAutomationFuture]
...
-   Watch [The Terrifying Cost of "Free" Websites](https://www.youtube.com/watch?v=5pFX2P7JLwA){target="_blank"} [-@TerrifyingCostFree]
...
-   [*Strengthening Net Neutrality in Canada*](https://crtc.gc.ca/eng/internet/diff.htm){target="_blank"} [-@governmentofcanadaStrengtheningNetNeutrality2016]
...
-   Read [How to Write a Notable Editorial](https://www.wikihow.com/Write-a-Notable-Editorial){target="_blank"} [-@4WaysWrite].
...
-   Skim the following article in which the authors present a framework for digital wisdom, as well as practical practices that can help navigate the digital in our daily lives.
    -   [*A Framework for Digital Wisdom in Higher Education*](https://christianscholars.com/a-framework-for-digital-wisdom-in-higher-education/){target="_blank"} [-@FrameworkDigitalWisdom].
...
> Institutions of higher education have a crucial role and responsibility at this moment of technological change to form people who will flourish in our so-called digital age. [-@FrameworkDigitalWisdom, para. 1]
>
> Within the context of Christian higher education, the need to integrate new ICTs into our individual and institutional lives well and wisely---as we consider what technologies are doing to us and what we will do with them---is of utmost significance if we are committed to the cultivation of competence, character, and wisdom. [-@FrameworkDigitalWisdom, para. 6]
>
> Scripture enables us look behind and beyond our and others' online identities to see ourselves and others as embodied and relational beings made in the image of God. [-@FrameworkDigitalWisdom, para. 21]
>
> Our use of technologies must be shaped by our intentions and values, and we must be aware of how platform interfaces, permissions, algorithms, and other design elements could interfere with our goals and obligations. [-@FrameworkDigitalWisdom, para. 31]
...
>
> Every graduate is equipped to think truthfully, act justly, and live faithfully for the good of the world and the glory of God. [@trinitywesternuniversityMissionVisionTrinity]
...
<iframe src="https://create.twu.ca/h5p/wp-admin/admin-ajax.php?action=h5p_embed&id=632" width="880" height="886" frameborder="0" allowfullscreen="allowfullscreen" title="Self-Regulated Learning Tool"></iframe><script src="https://create.twu.ca/h5p/wp-content/plugins/h5p/h5p-php-library/js/h5p-resizer.js" charset="UTF-8"></script>
