...
> At Trinity Western University, you’ll experience an authentic and engaging community as you enrich your understanding of the world—preparing for a life of faithful engagement in your community and profession. We are deeply committed to providing a transformational education, where you will develop practical professional skills while exploring bigger ideas about who you are, what you believe, and what you’re called to do in the world [@trinitywesternuniversityEquippedLife].

Why is community so important to TWU, and how does it help us learn? Have a quick read about TWU's [Core Values](https://www.twu.ca/about-us/commitments/core-values){target="_blank"} [-@trinitywesternuniversityCoreValues]. At this point in the course, we hope you have taken full advantage of the online community and have personal examples of how these interactions have impacted you.
...
Watch [What is Social Learning?](https://www.youtube.com/watch?v=AB-_822TRms){target="_blank"} [-@brandlearningWhatSocialLearning2017]
...
-   Read [Social Learning in Online Environments](https://openpress.usask.ca/humanmooc/chapter/social-learning-in-online-environments/){target="_blank"} [-@spellman-cannSocialLearningOnline] on how we learn in community.
-   Read [Social Learning vs. Community Based Learning: What’s the Difference?](https://www.corporatelearningnetwork.com/learning-design/articles/social-learning-vs-community-based-learning-whats-the-difference){target="_blank"} [-@mariaSocialLearningVs2022] from a corporate HR Learning and Development perspective.
...
Share your thoughts by posting a comment on Learning Community, for example: "Sharing learning is valuable because ..." "Community learning in the workplace is valuable because ..."
:::

### Activity: Preparing for the Future

::: {.learning-activity time="20"}
TWU has a [Centre for Calling & Career Development](https://www.twu.ca/academics/academic-professional-support/centre-calling-career-development){target="_blank"} that aims to equip students for their future careers. Have a look at their Career Ready Framework below. Navigate through the sections and look specifically for the competencies related to social learning and digital skills.

<iframe src="https://create.twu.ca/h5p/wp-admin/admin-ajax.php?action=h5p_embed&amp;id=649" width="675" height="535" frameborder="0" allowfullscreen="allowfullscreen" title="Getting Started With Obsidian">
...
Navigate through the sections and look specifically for the competencies related to social learning and digital skills. [Click here](assets/u6/Career%20Ready%20Competency%20Framework%20(and%20Scoring)-%20August%202023.pdf){target="_blank"} to access the full framework.
...
Career Ready Framework. [Click here](assets/u6/Career%20Ready%20Competency%20Framework%20(and%20Scoring)-%20August%202023.pdf){target="_blank"} to access the full framework. :::

*Source*: From ["Centre for Calling & Career Development,"](https://www.twu.ca/academics/academic-professional-support/centre-calling-career-development){target="_blank"} by Trinity Western University. [@CentreCallingCareer2025]-->
...
:::: {.learning-activity time="20"}
[Watch: *What is the Future of Work?*](https://www.youtube.com/watch?v=EuDnSqAo784){target="_blank"} from the World Economic Forum [-@worldeconomicforumWhatFutureWork2022].
...
What do you think? Share your thoughts by posting a comment on Learning Community, for example:
...
:::: {.learning-activity time="30"}
In this activity we invite you to join the Learning Community discussion on the impact of digital technology on business.
...
> The theory and development of computer systems able to perform tasks normally requiring human intelligence, such as visual perception, speech recognition, decision-making, and translation between languages [@oxforduniversitypressArtificialIntelligence].

> The capacity of a computer, robot, programmed device, or software application to perform operations and tasks analogous to learning and decision making in humans, such as speech recognition or question answering [@dictionary.comArtificialIntelligence2024]
...
-   [How can AI be Used by University Students?](https://www.timeshighereducation.com/student/advice/how-can-ai-be-used-university-students){target="_blank"} [-@neillHowCanAI2023]
-   [10 Best AI Tools for Homework and Studying in 2024](https://mystudylife.com/10-best-ai-tools-to-help-students-learn-faster/){target="_blank"} [-@whantTop10AI]
...
Review TWU's policy on [*Academic Misconduct & Fraud*](https://www.twu.ca/about-us/policies-guidelines/university-policies/academic-misconduct-fraud){target="_blank"} [-@trinitywesternuniversityAcademicMisconductFraud]. In particular, read Guidelines for Use of Generative AI in Teaching and Learning. Is it academic fraud if you use Chat GPT to complete assignments at TWU?

<!-- Search online for key words related to this issue, such as "university concern policy artificial intelligence" and you will find numerous articles on the use of AI in universities, as well as emerging policies. The University of Toronto's guidelines and FAQ for [*ChatGPT and Generative AI in the Classroom*](https://www.viceprovostundergrad.utoronto.ca/strategic-priorities/digital-learning/special-initiative-artificial-intelligence/){target="_blank"} [-@GenerativeArtificialIntelligence] are one such example. -->
...
-   Any content produced by an artificial intelligence tool must be cited appropriately. Many organizations that publish standard citation formats now provide information on citing generative AI (e.g., [MLA Style Center](https://style.mla.org/citing-generative-ai/){target="_blank"}, [APA Style](https://apastyle.apa.org/blog/how-to-cite-chatgpt){target="_blank"}).
...
-   Watch [How AI Could Save (Not Destroy) Education](https://www.youtube.com/watch?v=hJP5GqnTrNo){target="_blank"} [-@khanHowAICould2023]
...
-   [*Perspectives of the Use of ChatGPT as a Tool for Online Education of English*](https://www.researchgate.net/publication/374483468_Perspectives_of_the_Use_of_ChatGPT_as_a_Tool_for_Online_Education_of_English){target="_blank"} [-@pokotiloPerspectivesUseChatGPT2023]
...
:::: {.learning-activity time="20"}
If you've used AI-generated text, it's pretty easy to spot when someone else is using it to generate emails, documents, or even assignments.  As you read resources, you may notice certain markers that seem artificial, or lacking a human voice. 
...
-   [Watch: *Plagiarizing ChatGPT - Is it Illegal?*](https://www.youtube.com/watch?v=zuvN8_6QIKk){target="_blank"} [-@lydaPlagiarizingChatGPTIt2022]
...
In this course, here is the policy we follow:

USE OF GENERATIVE AI

> TWU places a high value on academic integrity. Using an AI tool can shortcut the process of critical thinking, academic originality, and personal responsibility for content. Allowing partial use of AI in this course should not be viewed as circumventing this process. 

Because assignments in this course require you to demonstrate a high level of critical and original thought, the use of AI tools for producing initial content is permitted in some cases, but only as a starting point. 

If you use an AI tool to complete an assignment, you must: 

- Fact check with original sources. You will be responsible for any errors or omissions provided by the tool.

This is an important topic, not only in higher education but across industries that depend on creative and critical thinkers to drive progress in their fields. As one TWU English instructor wisely said:

>*"Don’t let anyone else speak for you."*

This includes AI. Use it thoughtfully and judiciously, but never let a tool replace your voice.
...
-   Read [*Collaborative Intelligence: Humans and AI are Joining Forces*](https://hbr.org/2018/07/collaborative-intelligence-humans-and-ai-are-joining-forces){target="_blank"} [-@wilsonCollaborativeIntelligenceHumans2018]
-   Watch [AI Automation And The Future Of The Workforce](https://www.youtube.com/watch?v=NBLeWpOqhAo){target="_blank"} [-@worldoffinancetvAIAutomationFuture2022]
...
-   Read [OpenAI Used Kenyan Workers on Less Than \$2 Per Hour to Make ChatGPT Less Toxic](https://time.com/6247678/openai-chatgpt-kenya-workers/){target="_blank"} [-@perrigoExclusiveOpenAIUsed2023] and [Inside Facebook's African Sweatshop](https://time.com/6147458/facebook-africa-content-moderation-employee-treatment/){target="_blank"} [-@perrigoFacebooksAfricanSweatshop2022]
-   Watch [Doing Grueling Work for an AI: Data Labeling](https://www.youtube.com/watch?v=ug_p2wHhla0){target="_blank"} [-@dwshiftDoingGruelingWork2023]
...
Share your thoughts on AI by posting a comment on Learning Community, for example:
...
-   Net neutrality
-   Digital redlining <!-- -   Diversity, equity and inclusion-->
...
<iframe scrolling="yes" src="https://create.twu.ca/h5p/wp-admin/admin-ajax.php?action=h5p_embed&amp;id=575" allowfullscreen="allowfullscreen" width="100%" height="1000" frameborder="0" title="INNO 101 Unit 6.5  Activity: Quiz: Problematic Online Behaviours">
...
How did you do? Have you encountered any of these behaviours online? Share your thoughts by posting a comment on Learning Community.
:::
...
-   Watch [The Terrifying Cost of "Free" Websites](https://www.youtube.com/watch?v=5pFX2P7JLwA){target="_blank"} [-@dropoutTerrifyingCostFree2016]
...
-   [Get Cyber Safe](https://www.getcybersafe.gc.ca/en){target="_blank"} [-@communicationssecurityestablishmentcanadaGetCyberSafe2020] is a national public awareness campaign created to inform Canadians about cyber security and the simple steps they can take to protect themselves online.
-   [Protecting your information and data when using applications- ITSAP.40.200](https://www.cyber.gc.ca/en/protecting-your-information-and-data-when-using-applications-itsap40200){target="_blank"} [-@communicationssecurityestablishmentcanadaProtectingYourInformation2023] from [Canadian Centre for Cyber Security](https://www.cyber.gc.ca/en){target="_blank"}
-   [*The Real Cost of the 'Free' Internet*](http://mediashift.org/2018/01/real-cost-free-internet/){target="_blank"} [-@tillmanRealCostFree2018]
-   [*Don't Be Evil: Should we use Google in Schools?*](https://link.springer.com/article/10.1007/s11528-021-00599-4){target="_blank"} [-@krutkaDontBeEvil2021]

Also review these resources on corporate sponsored research:

-   [Funding Bias](https://en.wikipedia.org/wiki/Funding_bias){target="_blank"} [-@FundingBias2025]
-   [Sponsors' Participation in Conduct and Reporting of Industry Trials: A Descriptive Study](https://trialsjournal.biomedcentral.com/articles/10.1186/1745-6215-13-146){target="_blank"} [-@lundhSponsorsParticipationConduct2012]
-   [Ad Blocking](https://en.wikipedia.org/wiki/Ad_blocking){target="_blank"} [-@AdBlocking2025]

Do you use [ad blocking](https://en.wikipedia.org/wiki/Ad_blocking){target="_blank"} software?
...
Share your thoughts on [Learning Community](https://twu.discourse.group/auth/microsoft_office365){target="_blank"} or use Hypothes.is to annotate and share your comments.
:::
...
-   **Discuss**: Join the discussion in Learning Community on philanthropy and corporate advertising. The key question is how can nonprofit organizations sustain free educational services for those who can't afford traditional education provision?
...
-   Read the following articles on the social media response to impersonation:
    -   [*Misleading and Deceptive Identities Policy (X)*](https://help.twitter.com/en/rules-and-policies/x-impersonation-and-deceptive-identities-policy){target="_blank"} [-@XsPlatformManipulation2025]
    -   [*How to Report a Facebook Account or Page That's Pretending to be me or Someone Else?*](https://www.facebook.com/help/174210519303259){target="_blank"} [-@ReportFacebookProfile]
<!--    -   [*Reporting Impersonation on Social Media*](https://saferinternet.org.uk/blog/reporting-impersonation-on-social-media){target="_blank"} [-@cawthorneReportingImpersonationSocial2016a]-->
...
-   [Watch: *How To Spot a SCAM Email (8 Ways)*](https://www.youtube.com/watch?v=C5jIvj7EcqE){target="_blank"} [-@auraHowSpotSCAM2022]

<div class="video-container">

{{< video https://www.youtube-nocookie.com/embed/C5jIvj7EcqE >}}

</div>

-   [Watch: *Cyber Sandra's Hacks - Social Media Impersonation*](https://www.youtube.com/watch?v=Ta6qq7wnpcA){target="_blank"} [-@cybersecurityagencyofsingaporeCyberSandrasHacks2021]
...
-   [*Your Photos can be Used in 'Catfishing' Romance Scams*](https://www.cbc.ca/radio/spark/380-phantom-traffic-jams-catfishing-scams-and-smart-speakers-1.4482967/your-photos-can-be-used-in-catfishing-romance-scams-1.4482985){target="_blank"} [-@cbcradioYourPhotosCan2018]
-   [*Identity, Love, and Catfishing*](http://educationaltechnology.ca/2393/){target="_blank"} [-@courosIdentityLoveCatfishing2013]
-   [*Would the Real 'Alec Couros' Please Stand Up*](http://educationaltechnology.ca/2466/){target="_blank"} [-@courosWouldRealAlec2014]
-   Visit this website that reports online scams: [ScamDigger Forum](https://scamdigger.com/forum/){target="_blank"} [-@ScamDiggerForumForum].
-   [Watch: *How to Detect a Facebook Scammer With Google Reverse Image Search*](https://www.youtube.com/watch?v=s6Q4U8DvJH8){target="_blank"} [-@courosHowDetectFacebook2014]
...
-   [*Facebook as Catfish Paradise: Its Community Standards Wears the Cone of Shame*](https://cogdogblog.com/2015/10/facebook-as-catfish-paradise-its-community-standards-wears-the-cone-of-shame/){target="_blank"} [-@cogdogtheblogFacebookCatfishParadise2015]

Feel free to share personal reflections on the phenomenon of online impersonation by posting a comment on Learning Community.
:::

### Internet Trolling {.unnumbered}

> <!-- //todo #29 -->Sometimes trolls live under bridges. But not everyone living under a bridge is a troll. (Wikimedia Foundations, n.d.)

<!-- //todo #30 -->It is estimated that that the internet has about 5.35 billion users, almost half the population of the world (Tsvetkova, 2023). With the growing number of internet and social media users we are witnessing an increase in antisocial behaviour online.
...
> In slang, a troll is a person who posts deliberately offensive or provocative messages online (such as in social media, a newsgroup, a forum, a chat room, an online video game) or who performs similar behaviors in real life. The methods and motivations of trolls can range from benign to sadistic. These messages can be inflammatory, insincere, digressive, extraneous, or off-topic, and may have the intent of provoking others into displaying emotional responses, or manipulating others' perception, thus acting as a bully or a provocateur. The behavior is typically for the troll's amusement, or to achieve a specific result such as disrupting a rival's online activities or purposefully causing confusion or harm to others. [@wikipediaTrollSlang2024]

### Activity: Trolling in Social Media

:::: {.learning-activity time="30"}

-   Take the [Spot the Troll](https://spotthetroll.org/){target="_blank"} quiz [@clemsonuniversityInternetTrollDisinformation], which uses images of real social media content. How did you do? Did some of the profiles surprise you? Have you encountered these types of profiles on social media?
-   As you read the following, pay particular attention to strategies for dealing with trolling behaviour.
    -   [Troll (Slang)](https://en.wikipedia.org/wiki/Troll_(slang)){target="_blank"} [-@wikipediaTrollSlang2024]
    -   [What is a Troll?](https://meta.wikimedia.org/wiki/What_is_a_troll){target="_blank"} [-@wikimediafoundationsWhatTroll]
    -   [Internet Trolling: How do you Spot a Real Troll?](https://www.lifewire.com/what-is-internet-trolling-3485891){target="_blank"} [-@moreauHeresWhatYou2024]
-   Watch [The Secret Confessions of an Internet Troll](https://www.youtube.com/watch?v=5BQp3V_34BE){target="_blank"} [-@viceSecretConfessionsInternet2016]
...
-   Read the following articles and add or reply to annotations on Hypothes.is, focusing on how the research relates to your own online experience. Remember to tag your posts using the course code: LDRS101.
    -   ['Don't Feed the Trolls' Really is Good Advice -- Here's the Evidence](https://theconversation.com/dont-feed-the-trolls-really-is-good-advice-heres-the-evidence-63657){target="_blank"} [-@marchDontFeedTrolls2016]
    -   [How Empathy can Make or Break a Troll](https://theconversation.com/how-empathy-can-make-or-break-a-troll-80680){target="_blank"} [-@marchHowEmpathyCan2017]

After viewing the resources, how can you spot trolls online? Share your thoughts by posting a comment on Learning Community.
:::

### Online Harassment {.unnumbered}

> 41 % of Americans have been personally subjected to harassing behavior online, and an even larger share (66 %) has witnessed these behaviors directed at others [@dugganOnlineHarassment20172017].
...
<!-- -   [*Online Harassment*](https://www.pewresearch.org/internet/2014/10/22/online-harassment/){target="_blank"} [-@dugganOnlineHarassment20172017]. (Note that this is an 8-page report; click through to read it all.)-->
- [*Info Sheet: Cyberbullying*](https://www.publicsafety.gc.ca/cnt/rsrcs/pblctns/2015-r038/index-en.aspx){target="_blank"} [-@publicsafetycanadaInfoSheetCyberbullying2018]
-   [*Q&A: What We've Learned About Online Harassment*](https://www.pewresearch.org/short-reads/2021/01/13/qa-what-weve-learned-about-online-harassment/){target="_blank"} [-@desilverQAWhatWeve2021]

::: note
Note in particular the finding that those "who have ever experienced more severe forms of harassment -- such as physical threats, stalking, sexual harassment or sustained harassment -- or multiple forms of harassing behaviors online have both risen substantially in the past three years. This is not the pattern we saw in prior surveys. There has been a markedly steeper rise in these measures since 2017, compared with the change between our 2014 and 2017 studies" [@desilverQAWhatWeve2021].
:::
...
-   [*Meta Community Standards*](https://transparency.meta.com/policies/community-standards/){target="_blank"} [-@metatransparencycenterFacebookCommunityStandards]
-   [*About Online Abuse*](https://help.twitter.com/en/safety-and-security/cyber-bullying-and-online-abuse){target="_blank"} [-@xhelpcenterOnlineAbuse]
...
-   [Watch: *Connected, but Alone?*](https://www.youtube.com/watch?v=t7Xr3AsBEK4){target="_blank"} [-@turkleConnectedAlone2012]
...
-   Finally, read the following article which summarizes a number of psychological disorders related to our use of digital technology:
    -   [*Eight new Mental Illnesses Brought to you by the Internet*](https://www.pcworld.com/article/448085/eight-new-mental-illnesses-brought-to-you-by-wait-for-it-the-internet.html){target="_blank"} [-@dashevskyEightNewMental2013]

Share your thoughts by posting a comment on Learning Community, for example:
...
> The Web as I envisaged it, we have not seen it yet. The future is still so much bigger than the past (Tim Berners-Lee, 2009, as cited in @mediumTimBernersLeeQuotes2023)
...
[*Net Neutrality Explained*](https://www.youtube.com/watch?v=p90McT24Z6w){target="_blank"} [-@thewallstreetjournalNetNeutralityExplained2015]
...
[*Internet Citizens: Defend Net Neutrality*](https://www.youtube.com/watch?v=wtt2aSV8wdw){target="_blank"} [-@cgpgreyInternetCitizensDefend2014]
...
:::: {.learning-activity time="60"}
Explore the issue of net neutrality. Here are some sample resources, but please search for additional resources that interest you. Seek out different perspectives on the topic to inform your views. First, have a look at a summary of [*Net Neutrality by Country*](https://en.wikipedia.org/wiki/Net_neutrality_by_country#:~:text=source%20or%20ownership.-,China,is%20available%20to%20their%20citizens){target="_blank"} [-@NetNeutralityCountry2024].

Next, click the topics below to explore different perspectives on this issue in Canada.

-   [*Strengthening Net Neutrality in Canada*](https://crtc.gc.ca/eng/internet/diff.htm){target="_blank"} [-@crtcgovernmentofcanadaStrengtheningNetNeutrality2018]
-   [*Big Tech vs. Canadian News: The Battle Over C-18, Explained*](https://www.youtube.com/watch?v=k5iRopjAwm4){target="_blank"} [-@cbcnewsBigTechVs2023]
-   [*Bill C-18: The Fallout over Google, Meta's Plans to Block News Links in Canada*](https://www.youtube.com/watch?v=W5YLvCEd1yE){target="_blank"} [-@globalnewsBillC18Fallout2023]
-   [*Debating Bill C-11---Internet Censorship for Canadians*](https://www.youtube.com/watch?v=bmd4sASKFRw){target="_blank"} [-@lewisDebatingBillC11Internet2023]
-   [*Poilievre: Warned About Justin Trudeau's Online Censorship Law*](https://www.youtube.com/watch?v=doPyNc6Sf_c){target="_blank"} [-@wionPoilievreWarnedJustin2023]
...
-   Share your thoughts on net neutrality by posting a comment on Learning Community. For example:
...
-   Watch [*Seneca Nation disconnected by Redlining*](https://www.youtube.com/watch?v=J5NV9BJx1_M){target="_blank"} [-@wgrztvSenecaNationDisconnected2021]
...
-   Listen to the podcast: [*Digital Redlining and Privacy*](https://teachinginhighered.com/podcast/digital-redlining-privacy/){target="_blank"} [-@gilliardDigitalRedliningPrivacy2016] with Chris Gilliard. Gilliard is a Professor of English whose scholarship concentrates on privacy, institutional technology policy, digital redlining, and the reinventions of discriminatory practices through data mining and algorithmic decision making, especially as these apply to college students.
-   Choose from the following resources to explore:
    -   [*Bad Algorithms are Making Racist Decisions*](https://www.cbc.ca/radio/spark/412-1.4887497/bad-algorithms-are-making-racist-decisions-1.4887504){target="_blank"} [-@cbcradioBadAlgorithmsAre2018]
    -   [*What Is Digital Redlining? Experts Explain the Nuances*](https://www.govtech.com/network/what-is-digital-redlining-experts-explain-the-nuances){target="_blank"} [-@quaintanceWhatDigitalRedlining2022]
    -   [*What is Digital Redlining and how Does it Perpetuate Poverty?*](https://communitytechnetwork.org/blog/digital-redlining-and-how-it-perputates-poverty/){target="_blank"} [-@communitytechnetworkWhatDigitalRedlining2023]

<!-- Also see the following articles that focus on racial and gender bias:

-   [*Google Search: Hyper-visibility as a Means of Rendering Black Women and Girls Invisible*](http://ivc.lib.rochester.edu/google-search-hyper-visibility-as-a-means-of-rendering-black-women-and-girls-invisible/){target="_blank"} [-@nobleGoogleSearchHypervisibility2013]
-   [*Pedagogy and the Logic of Platforms*](https://er.educause.edu/articles/2017/7/pedagogy-and-the-logic-of-platforms){target="_blank"} [-@gilliardPedagogyLogicPlatforms2017]
-   [*Digital Redlining, Access, and Privacy*](https://www.commonsense.org/education/articles/digital-redlining-access-and-privacy){target="_blank"} [-@gilliardDigitalRedliningAccess2016] -->
:::
...
-   [*10 Forms of Online Harassment*](https://computer.howstuffworks.com/10-forms-online-harassment.htm){target="_blank"} [-@hoyt10FormsOnline2015]
-   [*Cyberchondria*](https://karger.com/pps/article/86/3/129/282998/Cyberchondria-Challenges-of-Problematic-Online){target="_blank"} [-@starcevicCyberchondriaChallengesProblematic2017]
-   [*The Woman Whose Phone 'Misdiagnosed HIV'*](https://www.bbc.com/news/technology-39371100){target="_blank"} [-@wakefieldWomanWhosePhone2017] (complexities of mobile ownership in the developing world)
-   [*Face-off Between MPs and Social Media Giants Over Online Hate  Speech*](https://www.theguardian.com/media/2017/mar/14/face-off-mps-and-social-media-giants-online-hate-speech-facebook-twitter){target="_blank"} [-@travisFaceoffMPsSocial2017] (hate speech online)
-   [*Keystroke Logging*](https://en.wikipedia.org/wiki/Keystroke_logging){target="_blank"} [-@KeystrokeLogging2024]
-   [*The Price of Connection: Surveillance Capitalism*](https://theconversation.com/the-price-of-connection-surveillance-capitalism-64124){target="_blank"} [-@couldryPriceConnectionSurveillance2016] (surveillance capitalism)
-   [*How Bots Took Over Twitter*](https://hbr.org/2015/06/how-bots-took-over-twitter){target="_blank"} [-@samuelHowBotsTook2015] (bot problems)
-   [*Scams and how to Avoid Them*](https://www.consumer.org.nz/articles/scams?gclid=EAIaIQobChMIrOzE7qX71AIVxBiPCh0uzAKrEAAYASAAEgIXf_D_BwE){target="_blank"} [-@ScamsHowAvoid]
-   [*Fake News*](https://en.wikipedia.org/wiki/Fake_news){target="_blank"} [-@FakeNews2025]
...
-   Read [How to Write a Notable Editorial](https://www.wikihow.com/Write-a-Notable-Editorial){target="_blank"} [-@posnerHowWriteNotable2025].
...
-   Skim the following article in which the authors present a framework for digital wisdom, as well as practical practices that can help navigate the digital in our daily lives.
    -   [*A Framework for Digital Wisdom in Higher Education*](https://christianscholars.com/a-framework-for-digital-wisdom-in-higher-education/){target="_blank"} [-@paulusFrameworkDigitalWisdom2019].

Here are some quotes that resonate [@paulusFrameworkDigitalWisdom2019]. Feel free to highlight your quotes using Hypothes.is, or in your personal Obsidian notes.

> Institutions of higher education have a crucial role and responsibility at this moment of technological change to form people who will flourish in our so-called digital age [@paulusFrameworkDigitalWisdom2019, para. 1].
>
> Within the context of Christian higher education, the need to integrate new ICTs into our individual and institutional lives well and wisely---as we consider what technologies are doing to us and what we will do with them---is of utmost significance if we are committed to the cultivation of competence, character, and wisdom [@paulusFrameworkDigitalWisdom2019, para. 6].
>
> Scripture enables us look behind and beyond our and others' online identities to see ourselves and others as embodied and relational beings made in the image of God. [@paulusFrameworkDigitalWisdom2019, para. 21]
>
> Our use of technologies must be shaped by our intentions and values, and we must be aware of how platform interfaces, permissions, algorithms, and other design elements could interfere with our goals and obligations. [@paulusFrameworkDigitalWisdom2019, para. 31]
...
>
> Every graduate is equipped to think truthfully, act justly, and live faithfully for the good of the world and the glory of God [@trinitywesternuniversityMissionVisionTrinity2025].
